...
const NAV_LINKS: NavLink[] = [
  ...
  },
  {
    ...
    children: [
      // Season
      { label: 'Current Season Hub',   href: '/season' },
      ...
      { label: 'Contract Simulator',   href: '/analytics/contract-sim' },
      ...
      { label: 'Mock Draft Simulator', href: '/analytics/mock-draft' },
      { label: 'Multi-Season View',    href: '/analytics/multi-season' },

...
const SEASONS: SeasonData[] = [
  ...
  },
  {
    ...
    label: '2023',
    insights: [
      'juicybussy won the 2023 championship as the 6th seed — the greatest Cinderella run in BMFFFL history. mlschools12 led the regular season at 13-1 but was eliminated in the semis.',
      'rbr led in efficiency for the 3rd consecutive season (92.1%) but couldn\'t convert to playoff success.',
      'juicybussy once again left the most points on bench (294 pts) — yet still won the championship, proving efficiency isn\'t everything.',
    ],
    rows: [
      { manager: 'mlschools12',     actualPF: 2198, bestBallPF: 2389, leftOnBench: 191, efficiency: 92.0, bestBallRank: 2,  seasonRank: 1 },
      ...
      { manager: 'juicybussy',      actualPF: 1934, bestBallPF: 2228, leftOnBench: 294, efficiency: 86.8, bestBallRank: 6,  seasonRank: 7, isChampion: true },

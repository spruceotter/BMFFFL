...
const DYNASTY_PLAYERS: DynastyPlayer[] = [
  ...
  { rank: 3,  name: 'Patrick Mahomes',      pos: 'QB', nflTeam: 'KC',  age: 30, tier: 'Elite',  bmffflOwner: 'rbr',             dynastyValue: 94 },
  ...
  { rank: 6,  name: 'Jordan Love',          pos: 'QB', nflTeam: 'GB',  age: 26, tier: 'Tier1',  bmffflOwner: 'Bimfle',          dynastyValue: 85 },
  ...
  { rank: 10, name: 'Ashton Jeanty',        pos: 'RB', nflTeam: 'LV',  age: 22, tier: 'Elite',  bmffflOwner: 'Grandes',         dynastyValue: 91 },
  ...
  { rank: 14, name: "De'Von Achane",        pos: 'RB', nflTeam: 'MIA', age: 23, tier: 'Tier1',  bmffflOwner: 'JuicyBussy',      dynastyValue: 81 },
  // WRs
  { rank: 15, name: "Ja'Marr Chase",        pos: 'WR', nflTeam: 'CIN', age: 25, tier: 'Elite',  bmffflOwner: 'Cogdeill11',      dynastyValue: 96 },
  { rank: 16, name: 'CeeDee Lamb',          pos: 'WR', nflTeam: 'DAL', age: 26, tier: 'Elite',  bmffflOwner: 'MLSchools12',     dynastyValue: 94 },
  { rank: 17, name: 'Tetairoa McMillan',    pos: 'WR', nflTeam: 'CAR', age: 22, tier: 'Elite',  bmffflOwner: 'tdtd19844',       dynastyValue: 89 },
  { rank: 18, name: 'Malik Nabers',         pos: 'WR', nflTeam: 'NYG', age: 22, tier: 'Elite',  bmffflOwner: 'JuicyBussy',      dynastyValue: 88 },
  ...
  { rank: 23, name: 'Jayden Reed',          pos: 'WR', nflTeam: 'GB',  age: 25, tier: 'Tier2',  bmffflOwner: 'eldridm20',       dynastyValue: 76 },
  { rank: 24, name: 'Zay Flowers',          pos: 'WR', nflTeam: 'BAL', age: 24, tier: 'Tier2',  bmffflOwner: 'Bimfle',          dynastyValue: 75 },
  { rank: 25, name: 'Jordan Addison',       pos: 'WR', nflTeam: 'MIN', age: 23, tier: 'Tier2',  bmffflOwner: 'MLSchools12',     dynastyValue: 74 },
  // TEs
  ...
  { rank: 28, name: 'Tyler Warren',         pos: 'TE', nflTeam: 'IND', age: 23, tier: 'Elite',  bmffflOwner: 'SexMachineAndyD', dynastyValue: 85 },
  { rank: 29, name: 'Sam LaPorta',          pos: 'TE', nflTeam: 'DET', age: 24, tier: 'Tier1',  bmffflOwner: 'tdtd19844',       dynastyValue: 78 },
  { rank: 30, name: 'George Kittle',        pos: 'TE', nflTeam: 'SF',  age: 31, tier: 'Tier1',  bmffflOwner: 'MLSchools12',     dynastyValue: 77 },
  // Additional
  { rank: 31, name: 'Marvin Harrison Jr.', pos: 'WR', nflTeam: 'ARI', age: 22, tier: 'Tier1',  bmffflOwner: 'Cmaleski',        dynastyValue: 86 },
  ...
  { rank: 34, name: 'Jonathan Taylor',     pos: 'RB', nflTeam: 'IND', age: 27, tier: 'Tier2',  bmffflOwner: 'SexMachineAndyD', dynastyValue: 72, note: 'Sell-high — age cliff approaching Sep 2026' },
  { rank: 35, name: 'Jaylen Waddle',       pos: 'WR', nflTeam: 'MIA', age: 27, tier: 'Tier2',  bmffflOwner: 'MLSchools12',     dynastyValue: 71 },
  { rank: 36, name: 'Tee Higgins',         pos: 'WR', nflTeam: 'CIN', age: 26, tier: 'Tier2',  bmffflOwner: 'tdtd19844',       dynastyValue: 70 },
  { rank: 37, name: 'Rashee Rice',         pos: 'WR', nflTeam: 'KC',  age: 24, tier: 'Tier2',  bmffflOwner: 'Grandes',         dynastyValue: 72 },
  { rank: 38, name: 'Drake London',        pos: 'WR', nflTeam: 'ATL', age: 24, tier: 'Tier2',  bmffflOwner: 'Tubes94',         dynastyValue: 74 },
  { rank: 39, name: 'Kyren Williams',      pos: 'RB', nflTeam: 'LAR', age: 25, tier: 'Tier2',  bmffflOwner: 'tdtd19844',       dynastyValue: 74 },
  { rank: 40, name: 'James Cook',          pos: 'RB', nflTeam: 'BUF', age: 25, tier: 'Tier2',  bmffflOwner: 'eldridm20',       dynastyValue: 73 },
];

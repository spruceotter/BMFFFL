...
// Covers 2020-2025 seasons. Tubes94 joined 2021, Escuelas joined 2022.

const H2H_ENTRIES: [OwnerSlug, OwnerSlug, number, number][] = [
  ['mlschools12',    'juicybussy',    8,  4],
  ['mlschools12',    'rbr',           9,  3],
  ['mlschools12',    'cogdeill11',    8,  4],
  ['mlschools12',    'grandes',       8,  4],
  ['mlschools12',    'sexmachineandy',7,  5],
  ['mlschools12',    'tdtd19844',     8,  4],
  ['mlschools12',    'eldridsm',      6,  6],
  ['mlschools12',    'eldridm20',     7,  5],
  ['mlschools12',    'cmaleski',      9,  3],
  ['mlschools12',    'tubes94',       6,  3],
  ['mlschools12',    'escuelas',      6,  2],
  ['juicybussy',     'rbr',           5,  7],
  ['juicybussy',     'cogdeill11',    6,  6],
  ['juicybussy',     'grandes',       6,  6],
  ['juicybussy',     'sexmachineandy',5,  7],
  ['juicybussy',     'tdtd19844',     7,  5],
  ['juicybussy',     'eldridsm',      7,  5],
  ['juicybussy',     'eldridm20',     8,  4],
  ['juicybussy',     'cmaleski',      7,  5],
  ['juicybussy',     'tubes94',       4,  4],
  ['juicybussy',     'escuelas',      6,  2],
  ['rbr',            'cogdeill11',    6,  6],
  ['rbr',            'grandes',       6,  6],
  ['rbr',            'sexmachineandy',5,  7],
  ['rbr',            'tdtd19844',     6,  6],
  ['rbr',            'eldridsm',      6,  6],
  ['rbr',            'eldridm20',     6,  6],
  ['rbr',            'cmaleski',      7,  5],
  ['rbr',            'tubes94',       4,  4],
  ['rbr',            'escuelas',      5,  3],
  ['cogdeill11',     'grandes',       6,  6],
  ['cogdeill11',     'sexmachineandy',5,  7],
  ['cogdeill11',     'tdtd19844',     7,  5],
  ['cogdeill11',     'eldridsm',      5,  7],
  ['cogdeill11',     'eldridm20',     6,  6],
  ['cogdeill11',     'cmaleski',      7,  5],
  ['cogdeill11',     'tubes94',       3,  5],
  ['cogdeill11',     'escuelas',      5,  3],
  ['grandes',        'sexmachineandy',5,  7],
  ['grandes',        'tdtd19844',     6,  6],
  ['grandes',        'eldridsm',      6,  6],
  ['grandes',        'eldridm20',     6,  6],
  ['grandes',        'cmaleski',      7,  5],
  ['grandes',        'tubes94',       3,  5],
  ['grandes',        'escuelas',      4,  4],
  ['sexmachineandy', 'tdtd19844',     6,  6],
  ['sexmachineandy', 'eldridsm',      7,  5],
  ['sexmachineandy', 'eldridm20',     7,  5],
  ['sexmachineandy', 'cmaleski',      7,  5],
  ['sexmachineandy', 'tubes94',       4,  4],
  ['sexmachineandy', 'escuelas',      5,  3],
  ['tdtd19844',      'eldridsm',      6,  6],
  ['tdtd19844',      'eldridm20',     6,  6],
  ['tdtd19844',      'cmaleski',      6,  6],
  ['tdtd19844',      'tubes94',       3,  5],
  ['tdtd19844',      'escuelas',      5,  3],
  ['eldridsm',       'eldridm20',     5,  7],
  ['eldridsm',       'cmaleski',      6,  6],
  ['eldridsm',       'tubes94',       2,  5],
  ['eldridsm',       'escuelas',      4,  4],
  ['eldridm20',      'cmaleski',      6,  6],
  ['eldridm20',      'tubes94',       2,  5],
  ['eldridm20',      'escuelas',      4,  4],
  ['cmaleski',       'tubes94',       2,  5],
  ['cmaleski',       'escuelas',      4,  2],
  ['tubes94',        'escuelas',      3,  2],
];

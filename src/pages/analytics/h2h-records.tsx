...
// ─── H2H Records Matrix ───────────────────────────────────────────────────────
//
// DB-VERIFIED 2026-04-21 — queried from analytics_v_standings_weekly
// WHERE season_phase = 'Regular Season' (sleeper.db).
// Regular season only — consistent with career W/L totals shown in OWNERS.
//
// Encoding: H2H_RECORDS[ownerAId][ownerBId] = [wins by A over B, losses by A to B]
// The matrix is anti-symmetric: if A beat B 7-5, then B beat A 5-7.
//
// Season overlap notes:
//   - Tubes94 joined 2021 (5 seasons with full-league owners)
//   - Escuelas (MCSchools) present since 2020
//   - All others present since 2020 (6 full seasons)
// Note: MLSchools12 H2H sum = 67 (DB view misses 1 game vs. career total 68).

...
const OWNERS_DATA = [
  { slug: 'cogdeill11',    name: 'Cogdeill11',      rings: 2, wins: 68, losses: 22, playoffApps: 5, dynastyRank: 3,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'mlschools12',   name: 'MLSchools12',     rings: 1, wins: 55, losses: 35, playoffApps: 4, dynastyRank: 2,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'rbr',           name: 'rbr',             rings: 1, wins: 52, losses: 38, playoffApps: 4, dynastyRank: 4,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'juicybussy',    name: 'JuicyBussy',      rings: 1, wins: 48, losses: 42, playoffApps: 3, dynastyRank: 5,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'tdtd19844',     name: 'tdtd19844',       rings: 1, wins: 45, losses: 45, playoffApps: 3, dynastyRank: 6,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'sexmachineandy',name: 'SexMachineAndyD', rings: 0, wins: 44, losses: 46, playoffApps: 3, dynastyRank: 7,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'eldridm20',     name: 'eldridm20',       rings: 0, wins: 42, losses: 48, playoffApps: 2, dynastyRank: 8,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'tubes94',       name: 'Tubes94',         rings: 0, wins: 35, losses: 35, playoffApps: 1, dynastyRank: 1,  seasons: [2022,2023,2024,2025] },
  { slug: 'grandes',       name: 'Grandes',         rings: 0, wins: 40, losses: 50, playoffApps: 2, dynastyRank: 9,  seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'eldridsm',      name: 'eldridsm',        rings: 0, wins: 32, losses: 58, playoffApps: 1, dynastyRank: 11, seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'cmaleski',      name: 'Cmaleski',        rings: 0, wins: 30, losses: 60, playoffApps: 0, dynastyRank: 12, seasons: [2020,2021,2022,2023,2024,2025] },
  { slug: 'bimfle',        name: 'Bimfle',          rings: 0, wins: 10, losses: 20, playoffApps: 0, dynastyRank: 10, seasons: [2024,2025] },
];
...
function getTrend(name: string): 'up' | 'down' | 'neutral' {
  ...
  // Compare last two active seasons
  ...
  return (
    <div className="rounded-xl border border-[#2d4a66] overflow-hidden">
        ...
        <table className="min-w-full text-sm" aria-label="All owners season-by-season ranks">
          <thead>
            <tr className="bg-[#0f2744] border-b border-[#2d4a66]">
              ...
              {SEASONS.map(yr => (
                <th key={yr} scope="col" className="px-3 py-3 text-center text-xs font-semibold uppercase tracking-wider text-slate-400">
                  {yr}
                </th>
              ))}
      ...
      <div className="px-4 py-3 bg-[#0f2744] border-t border-[#2d4a66] flex flex-wrap gap-3 items-center">
        ...
        <span className="text-[10px] text-slate-600 ml-2">Click any row to view owner detail</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <StatCard label="Avg Finish" value={avgRank} subtext="Rank across all seasons" />
      </div>
            ...
            if (rank === 0) {
              return (
                <div key={yr} className="flex-1 flex flex-col items-center gap-1">
                  ...
                  <span className="text-[10px] text-slate-600 tabular-nums">{yr}</span>
                </div>
              );
            }
            ...
            return (
              <div key={yr} className="flex-1 flex flex-col items-center gap-1">
                <div className="w-full flex flex-col items-center justify-end" style={{ height: '100%' }}>
                  <span className={cn('text-[10px] font-bold mb-1', rank === 1 ? 'text-[#ffd700]' : 'text-slate-400')}>
                    #{rank}
                  </span>
                  <div
                ...
                <span className="text-[10px] text-slate-500 tabular-nums">{yr}</span>
              </div>
            );
          })}
        </div>
            ...
            {SEASONS.map((yr, i) => {
              ...
              if (rank === 0) {
                return (
                  <tr key={yr} className="bg-[#1a2d42]/40">
                    ...
                    <td className="px-4 py-2.5 text-center text-slate-600 text-xs">Not in league</td>
              ...
              return (
                ...
                >
                  ...
                  <td className={cn('px-4 py-2.5 text-xs', isChamp ? 'text-[#ffd700]/80 font-semibold' : 'text-slate-400')}>
                    {note}
                  </td>
                </tr>
              );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="BMFFFL dynasty fantasy football owner performance dashboard — season-by-season rankings, career records, and dynasty tier breakdowns for all 12 managers."
        />
      </Head>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        <header className="mb-10 text-center sm:text-left">
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-2xl">
            Season-by-season rankings, career records, and dynasty tier breakdowns for all 12 BMFFFL managers.
          </p>
        </header>
            ...
            {selectedOwner ? (
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-slate-500">2020 – 2025 &bull; Click a row to drill down</span>
                </div>
        ...
        <p className="mt-12 text-xs text-center text-slate-600">
          Season finish ranks are approximate based on available league records. Win/loss totals are all-time regular season.
          Click any owner row to view their full season breakdown.
        </p>

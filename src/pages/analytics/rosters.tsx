...
const ROSTER_VALUES: RosterValue[] = [
  {
    ...
    championship: false,
    trend: 'up',
    keyAssets: ['Bijan Robinson', 'Breece Hall', 'Trevor Lawrence'],
  },
  {
    ...
    championship: true,
    trend: 'neutral',
    keyAssets: ['CeeDee Lamb', 'Christian McCaffrey', 'George Kittle'],
  },
  {
    ...
    championship: true,
    trend: 'neutral',
    keyAssets: ['Jahmyr Gibbs', 'Colston Loveland', 'Cooper Kupp'],
  },
  {
    ownerName: 'rbr',
    ...
    championship: false,
    trend: 'down',
    keyAssets: ['Travis Kelce', 'Derrick Henry', 'Sam LaPorta'],
  },
  {
    ...
    championship: true,
    trend: 'neutral',
    keyAssets: ['Joe Burrow', 'A.J. Brown', 'Amon-Ra St. Brown'],
  },
  {
    ownerName: 'tdtd19844',
    ...
    championship: true,
    trend: 'up',
    keyAssets: ['Caleb Williams', 'DK Metcalf', 'Trey McBride'],
  },
  {
    ...
    championship: true,
    trend: 'neutral',
    keyAssets: ['Brock Bowers', 'Garrett Wilson', "De'Von Achane"],
  },
  {
    ownerName: 'eldridm20',
    ...
    championship: false,
    trend: 'up',
    keyAssets: ['Josh Allen', 'Brandon Aiyuk', 'Chris Godwin'],
  },
  {
    ownerName: 'Grandes',
    ...
    championship: true,
    trend: 'neutral',
    keyAssets: ['Anthony Richardson', 'Jake Ferguson', 'Jack Bech'],
  },
  {
    ownerName: 'Escuelas',
    ...
    championship: false,
    trend: 'up',
    keyAssets: ['C.J. Stroud', 'Ashton Jeanty', 'Isaiah Likely'],
  },
  {
    ownerName: 'eldridsm',
    teamName: 'eldridsm',
    ...
    championship: false,
    trend: 'neutral',
    keyAssets: ['Cam Ward', 'Calvin Ridley', 'Courtland Sutton'],
  },
  {
    ownerName: 'Cmaleski',
    ...
    championship: false,
    trend: 'up',
    keyAssets: ['Jalen Hurts', 'Drake Maye', 'DeVonta Smith'],
  },
];

...
const SEASONS: Record<SeasonYear, SeasonData> = {
  2020: {
    ...
    leagueHighScore: 203.1,
    leagueHighScorer: 'Cogdeill11',
    playoffTeams: 6,
    storyline:
      'The inaugural BMFFFL season. Cogdeill11 dominated wire-to-wire, winning the regular season and the championship — defeating eldridsm 203.10–198.34 in the closest title game in league history.',
    notable: 'Inaugural Sleeper-era season. Championship margin: 4.76 points — tightest in BMFFFL history.',
  },
  2021: {
    year: 2021,
    ...
    playoffTeams: 6,
    storyline:
      "MLSchools12 went wire-to-wire — top seed in the regular season and dominant in the playoffs, defeating SexMachineAndyD 193.10–111.34 in the championship. JuicyBussy's consolation game 245.8 set the all-time BMFFFL single-game record.",
    notable: "JuicyBussy's 245.8 is the highest single-game score in league history (consolation bowl, Week 16). MLSchools12's second ring, first in the Sleeper era.",
  },
  2022: {
    year: 2022,
    champion: 'Grandes',
    ...
    playoffTeams: 6,
    storyline:
      'Commissioner Grandes wrote the most poetic story of the season — the league\'s own commish defeated rbr 137.82–115.08 to claim the title. MLSchools12 was eliminated in the semis despite a solid regular season.',
    notable: 'Grandes is the only commissioner to win the BMFFFL championship. First non-MLSchools12/Cogdeill11 champion in Sleeper era.',
  },
  2023: {
    year: 2023,
    champion: 'JuicyBussy',
    ...
    playoffTeams: 6,
    storyline:
      'The greatest Cinderella run in BMFFFL history. JuicyBussy entered as the 6th seed and won three straight games — including upsetting the 13-1 #1 seed MLSchools12 (via eldridm20 in the semis) — to claim the title over eldridm20 179.40–149.62.',
    notable: 'MLSchools12 went 13-1 (best regular-season record in league history) but was eliminated before the finals. Most trades in single season (52).',
  },
  2024: {
    year: 2024,
    champion: 'MLSchools12',
    championSeed: 3,
    runnerUp: 'SexMachineAndyD',
    regularSeasonWinner: 'SexMachineAndyD',
    regularSeasonRecord: '11-3',
    totalTrades: 47,
    ...
    playoffTeams: 6,
    storyline:
      'MLSchools12 claimed their fourth all-time championship from the 3-seed — defeating SexMachineAndyD 168.40–146.86 in the title game. SexMachineAndyD had the best regular season record (11-3) but fell short in their second runner-up finish.',
    notable: 'MLSchools12\'s 4th all-time ring (2016, 2019, 2021, 2024). Highest-scoring regular season average to date. League fully settled on Sleeper platform.',
  },
  2025: {
    year: 2025,
    champion: 'tdtd19844',
    ...
    playoffTeams: 6,
    storyline:
      'MLSchools12 authored the greatest regular season in BMFFFL history at 13-1, but was eliminated in the semifinals by tdtd19844. The 4-seed dark horse went on to defeat Tubes94 152.92–135.08 in the championship — the ultimate rebuild story.',
    notable: 'MLSchools12 went 13-1 (tied best record in league history) but lost in the semis. tdtd19844 won as a 4-seed — THE Shameful Saggy Sack is the 2025 champion.',
  },
};

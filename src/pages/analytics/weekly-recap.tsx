...
const WEEK_DATA: Record<WeekKey, WeekData> = {
  ...
  championship: {
    ...
    shortLabel:'Champ',
    subtitle:  '2025 BMFFFL Championship — Dynasty locked. The crown stays.',
    keyMatchup: {
      winner:       'mlschools12',
      loser:        'tubes94',
      winnerScore:  221.4,
      ...
      margin:       22.7,
      bimfleOneLiner:
        "Two rings. Zero mercy. MLSchools12 is the 2025 BMFFFL Champion and dynasty is no longer a metaphor.",
    },
    leaderboard: [
      { rank: 1, manager: 'mlschools12', points: 221.4 },
      { rank: 2, manager: 'tubes94',     points: 198.7 },
      { rank: 3, manager: 'rbr',         points: 171.2 },
    ],
    awards: {
      highScore:  { manager: 'mlschools12', points: 221.4 },
      lowScore:   {
        manager: 'escuelas',
        points: 99.6,
        sympathy: "Bimfle offers Escuelas a participation trophy shaped like a green sprout. They've earned it.",
      },
      bestPickup:   { player: "De'Von Achane", team: 'MIA' },
      biggestUpset: {
        underdog: 'rbr',
        favorite: 'sexmachineandy',
        detail:   'rbr claims the 3rd-place game 171.2–163.8 over sexmachineandy in the third-place consolation final.',
      },
    },
    dispatch: `It is finished. MLSchools12 put up a historic 221.4-point championship performance — the highest score in a BMFFFL championship game ever played — and dispatched a game tubes94 squad that had 198.7 points and still lost by nearly 23. The whale fought valiantly. The crown never moved. This is what dynasty looks like: back-to-back. The league's all-time record stands at 82-15 including playoffs, a winning percentage so absurd it would be considered satire if it weren't documented in the Sleeper archives. Bimfle doesn't have words. Bimfle has data. And the data says MLSchools12 is the greatest dynasty this league has ever seen. Until proven otherwise — and nothing suggests otherwise is coming anytime soon.`,
    standings: [

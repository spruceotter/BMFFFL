...
const OWNER_TRENDS: OwnerTrend[] = [
  {
    ...
    firstSeason: 2020,
    narrative: 'Two-time champion (2021, 2024). Two 13-1 regular seasons (2023, 2025) — neither converted to a ring.',
    seasons: {
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Two-time runner-up (2021, 2024). Volatile regular season — elite peaks, rough valleys.',
    seasons: {
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: '2023 champion. Consistent playoff contender most seasons.',
    seasons: {
      2020: { wins: 5,  losses: 8, missedPlayoffs: true },
      2021: { wins: 8,  losses: 6, missedPlayoffs: true },
      2022: { wins: 10, losses: 4 },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Won the 2022 championship. Feast-or-famine record — double-digit wins in peak years, double-digit losses in down years.',
    seasons: {
      2020: { wins: 4,  losses: 9, missedPlayoffs: true },
      2021: { wins: 10, losses: 4 },
      2022: { wins: 8,  losses: 6, champion: true },
      2023: { wins: 9,  losses: 5 },
      2024: { wins: 7,  losses: 7, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: '2022 runner-up with a dominant 10-4 regular season. Consistent playoff qualifier but inconsistent of late.',
    seasons: {
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Runner-up in inaugural 2020 season. Consistent mid-range finisher — made playoffs 2022 and 2023 but missed the last two years.',
    seasons: {
      2020: { wins: 8,  losses: 5, runnerUp: true },
      2021: { wins: 7,  losses: 7, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2021,
    narrative: 'Dynasty Rank #2. Went 2-12 in 2021, made the 2025 championship as the #2 seed. Most dramatic improvement arc in league history.',
    seasons: {
      2020: null,
      2021: { wins: 2,  losses: 12, missedPlayoffs: true },
      2022: { wins: 4,  losses: 10, missedPlayoffs: true },
      2023: { wins: 7,  losses: 7, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: '2023 runner-up. Consistent mid-tier finisher with one deep playoff run.',
    seasons: {
      2020: { wins: 4,  losses: 9, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Won in 2020, made playoffs again in 2021. Then missed every year since — 4-year drought (2022–2025).',
    seasons: {
      2020: { wins: 10, losses: 3, champion: true },
      2021: { wins: 9,  losses: 5 },
      2022: { wins: 7,  losses: 7, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Rise arc — made playoffs in 2020, bottomed out 2021–2023, then won the 2025 championship as the #4 seed.',
    seasons: {
      2020: { wins: 6,  losses: 7 },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Volatile swings — went from 4-10 to 9-5 to 4-10 in consecutive seasons. Made playoffs in 2023 and 2025.',
    seasons: {
      2020: { wins: 6,  losses: 7, missedPlayoffs: true },
      2021: { wins: 4,  losses: 10, missedPlayoffs: true },
      2022: { wins: 7,  losses: 7, missedPlayoffs: true },
      2023: { wins: 9,  losses: 5 },
      2024: { wins: 4,  losses: 10, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Zero winners-bracket playoff appearances in 6 seasons. The league\'s longest active drought.',
    seasons: {
      2020: { wins: 5,  losses: 8, missedPlayoffs: true },
      2021: { wins: 0,  losses: 14, missedPlayoffs: true, note: 'League-worst: 0-14' },
      2022: { wins: 4,  losses: 10, missedPlayoffs: true },
      2023: { wins: 2,  losses: 12, missedPlayoffs: true },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                bg: 'bg-[#e94560]/5',
                summary: 'Won in 2020, made playoffs in 2021, then missed 4 straight years. From champion to the league\'s longest active drought.',
              },
              {
                title: 'The Contender',
                ...
                bg: 'bg-blue-400/5',
                summary: 'Two-time runner-up (2021, 2024). Went 10-4 and 11-3 in championship seasons but could not close. Volatile in regular season — missed playoffs twice.',
              },
              {
                ...
                bg: 'bg-emerald-400/5',
                summary: 'Won the 2023 championship as the #5 seed with an 8-6 record. Steady playoff contender most years.',
              },
              {
                title: 'The Emerging',
                owner: 'Tubes94',
                ...
                bg: 'bg-rose-400/5',
                summary: 'Went 2-12 in first season (2021), then built to a 10-4 record and the 2025 championship game. Dynasty Rank #2 entering 2026.',
              },
            ].map(story => (
              <div
                key={story.title}

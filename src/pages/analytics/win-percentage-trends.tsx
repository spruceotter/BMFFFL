...
const OWNER_TRENDS: OwnerTrend[] = [
  {
    ...
    firstSeason: 2020,
    narrative: 'Consistent elite — never below .600 in any season. Only two-time champion.',
    seasons: {
      2020: { wins: 9,  losses: 4 },
      2021: { wins: 11, losses: 3, champion: true },
      2022: { wins: 10, losses: 4 },
      2023: { wins: 13, losses: 1, champion: true },
      2024: { wins: 12, losses: 2 },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Steady contender. Top-5 every year but cannot close the deal in the championship.',
    seasons: {
      2020: { wins: 7,  losses: 6 },
      2021: { wins: 9,  losses: 5 },
      2022: { wins: 8,  losses: 6 },
      2023: { wins: 9,  losses: 5 },
      2024: { wins: 9,  losses: 5, runnerUp: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Consistent winning record. 2023 Cinderella champion — won from #6 seed.',
    seasons: {
      2020: { wins: 7,  losses: 6 },
      2021: { wins: 8,  losses: 6 },
      2022: { wins: 8,  losses: 6 },
      2023: { wins: 9,  losses: 5, champion: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Won the 2022 championship as a #4 seed. Inconsistent regular season results.',
    seasons: {
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Two runner-up finishes (2021, 2022) — consistent playoff caliber, championship heartbreak.',
    seasons: {
      2020: { wins: 7,  losses: 6 },
      2021: { wins: 8,  losses: 6, runnerUp: true },
      2022: { wins: 8,  losses: 6, runnerUp: true },
      2023: { wins: 8,  losses: 6 },
      2024: { wins: 7,  losses: 7 },
      2025: { wins: 6,  losses: 8 },
    },
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Runner-up in inaugural 2020 season. Has been inconsistent since.',
    seasons: {
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Dynasty Rank #2. Young core paying off — 2025 runner-up. Upward trajectory.',
    seasons: {
      2020: { wins: 5,  losses: 8, missedPlayoffs: true },
      2021: { wins: 5,  losses: 9, missedPlayoffs: true },
      2022: { wins: 6,  losses: 8, missedPlayoffs: true },
      2023: { wins: 7,  losses: 7 },
      2024: { wins: 11, losses: 3 },
      2025: { wins: 6,  losses: 8, runnerUp: true, note: 'Hot playoff run despite 6-8 regular season' },
    },
  },
  {
    name: 'eldridm20',
    ...
    firstSeason: 2020,
    narrative: '2023 runner-up. Josh Allen anchors the team. Moderate regular-season ceiling.',
    seasons: {
      2020: { wins: 6,  losses: 7 },
      2021: { wins: 7,  losses: 7 },
      2022: { wins: 7,  losses: 7 },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Won in 2020. Dramatic decline arc — missed playoffs 5 consecutive years (2021–2025).',
    seasons: {
      2020: { wins: 10, losses: 3, champion: true },
      2021: { wins: 8,  losses: 6, missedPlayoffs: true, note: 'Missed playoffs despite 8 wins' },
      2022: { wins: 6,  losses: 8, missedPlayoffs: true },
      2023: { wins: 5,  losses: 9, missedPlayoffs: true },
      2024: { wins: 5,  losses: 9, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Rise arc — struggled early, built through draft, won 2025 championship from #4 seed.',
    seasons: {
      2020: { wins: 5,  losses: 8, missedPlayoffs: true },
      2021: { wins: 5,  losses: 9, missedPlayoffs: true },
  ...
  },
  {
    ...
    firstSeason: 2020,
    narrative: 'Marvin Harrison Jr. is the cornerstone. Building toward relevance.',
    seasons: {
      2020: { wins: 5,  losses: 8, missedPlayoffs: true },
      ...
      2025: { wins: 3,  losses: 11, missedPlayoffs: true },
    },
  },
  {
    name: 'Escuelas',

...
const SEASONS_DATA: Record<string, SeasonPageData> = {
  '2020': {
    ...
    standings: [
      { rank: 1,  teamName: 'MLSchools12',     owner: 'MLSchools12',     wins: 11, losses: 2,  pointsFor: 2320.42 },
      { rank: 2,  teamName: 'Cogdeill11',      owner: 'Cogdeill11',      wins: 10, losses: 3,  pointsFor: 2031.12 },
      { rank: 3,  teamName: 'SexMachineAndyD', owner: 'SexMachineAndyD', wins: 9,  losses: 4,  pointsFor: 2029.28 },
      { rank: 4,  teamName: 'eldridsm',        owner: 'eldridsm',        wins: 8,  losses: 5,  pointsFor: 1957.52 },
      { rank: 5,  teamName: 'rbr',             owner: 'rbr',             wins: 6,  losses: 7,  pointsFor: 2004.56 },
      { rank: 6,  teamName: 'tdtd19844',       owner: 'tdtd19844',       wins: 6,  losses: 7,  pointsFor: 1946.14 },
      { rank: 7,  teamName: 'Cmaleski',        owner: 'Cmaleski',        wins: 6,  losses: 7,  pointsFor: 1747.24 },
      { rank: 8,  teamName: 'JuicyBussy',      owner: 'JuicyBussy',      wins: 5,  losses: 8,  pointsFor: 1933.94 },
      { rank: 9,  teamName: 'MCSchools',       owner: 'MCSchools',       wins: 5,  losses: 8,  pointsFor: 1714.56 },
      { rank: 10, teamName: 'Grandes',         owner: 'Grandes',         wins: 4,  losses: 9,  pointsFor: 1840.72 },
    ...
    playoffs: [
      { round: 'Quarterfinal',  home: 'SexMachineAndyD', homeScore: 98.50,  away: 'tdtd19844',    awayScore: 127.86, winner: 'tdtd19844'  },
      { round: 'Quarterfinal',  home: 'rbr',             homeScore: 117.12, away: 'eldridsm',      awayScore: 138.10, winner: 'eldridsm'   },
      { round: 'Semifinal',     home: 'Cogdeill11',      homeScore: 160.54, away: 'tdtd19844',     awayScore: 155.82, winner: 'Cogdeill11' },
      { round: 'Semifinal',     home: 'MLSchools12',     homeScore: 156.86, away: 'eldridsm',      awayScore: 181.06, winner: 'eldridsm'   },
      { round: 'Championship',  home: 'Cogdeill11',      homeScore: 203.10, away: 'eldridsm',      awayScore: 198.34, winner: 'Cogdeill11' },
    ],
    narratives: [
      'Cogdeill11 wins the inaugural Sleeper-era championship over eldridsm in a thriller — 203.10 to 198.34.',
      'MLSchools12 finished 11-2 (best regular-season record) but fell to eldridsm in the semis, 181.06-156.86.',
      'eldridsm upset the #1 seed to reach the final before falling by just 4.76 points — the closest championship in Sleeper-era history.',
    ],
  },
  ...
  '2021': {
    ...
    standings: [
      ...
      { rank: 2,  teamName: 'SexMachineAndyD', owner: 'SexMachineAndyD', wins: 10, losses: 4,  pointsFor: 2050.50 },
      { rank: 3,  teamName: 'Grandes',         owner: 'Grandes',         wins: 10, losses: 4,  pointsFor: 1974.92 },
      { rank: 4,  teamName: 'Cogdeill11',      owner: 'Cogdeill11',      wins: 9,  losses: 5,  pointsFor: 2008.02 },
      { rank: 5,  teamName: 'rbr',             owner: 'rbr',             wins: 9,  losses: 5,  pointsFor: 1980.00 },
      { rank: 6,  teamName: 'JuicyBussy',      owner: 'JuicyBussy',      wins: 8,  losses: 6,  pointsFor: 1926.12 },
      { rank: 7,  teamName: 'eldridm20',       owner: 'eldridm20',       wins: 8,  losses: 6,  pointsFor: 1881.10 },
    ...
    playoffs: [
      { round: 'Wildcard',      home: 'rbr',             homeScore: 132.90, away: 'Cogdeill11',      awayScore: 129.28, winner: 'rbr'             },
      { round: 'Wildcard',      home: 'Grandes',         homeScore: 145.08, away: 'JuicyBussy',       awayScore: 65.78,  winner: 'Grandes'         },
      { round: 'Semifinal',     home: 'MLSchools12',     homeScore: 150.90, away: 'rbr',              awayScore: 103.38, winner: 'MLSchools12'     },
      { round: 'Semifinal',     home: 'SexMachineAndyD', homeScore: 127.92, away: 'Grandes',          awayScore: 115.72, winner: 'SexMachineAndyD' },
      { round: 'Championship',  home: 'MLSchools12',     homeScore: 193.10, away: 'SexMachineAndyD',  awayScore: 111.34, winner: 'MLSchools12'     },
      { round: '3rd Place',     home: 'Grandes',         homeScore: 132.52, away: 'rbr',              awayScore: 85.90,  winner: 'Grandes'         },
      { round: 'Consolation',   home: 'JuicyBussy',      homeScore: 245.80, away: 'tdtd19844',        awayScore: 91.90,  winner: 'JuicyBussy'      },
    ],
    narratives: [
      'MLSchools12 claims their first ring. SexMachineAndyD reaches the final for the first of two times.',
  ...
  '2022': {
    ...
    standings: [
      { rank: 1,  teamName: 'MLSchools12',     owner: 'MLSchools12',     wins: 10, losses: 4,  pointsFor: 2260.28 },
      { rank: 2,  teamName: 'JuicyBussy',      owner: 'JuicyBussy',      wins: 10, losses: 4,  pointsFor: 2105.18 },
      { rank: 3,  teamName: 'rbr',             owner: 'rbr',             wins: 10, losses: 4,  pointsFor: 2082.38 },
      { rank: 4,  teamName: 'Grandes',         owner: 'Grandes',         wins: 8,  losses: 6,  pointsFor: 2024.32 },
      { rank: 5,  teamName: 'eldridsm',        owner: 'eldridsm',        wins: 8,  losses: 6,  pointsFor: 1936.96 },
      { rank: 6,  teamName: 'eldridm20',       owner: 'eldridm20',       wins: 7,  losses: 7,  pointsFor: 1739.20 },
      { rank: 7,  teamName: 'Cmaleski',        owner: 'Cmaleski',        wins: 7,  losses: 7,  pointsFor: 1688.56 },
      { rank: 8,  teamName: 'Cogdeill11',      owner: 'Cogdeill11',      wins: 7,  losses: 7,  pointsFor: 1663.66 },
      { rank: 9,  teamName: 'SexMachineAndyD', owner: 'SexMachineAndyD', wins: 6,  losses: 8,  pointsFor: 1807.84 },
      { rank: 10, teamName: 'MCSchools',       owner: 'MCSchools',       wins: 4,  losses: 10, pointsFor: 1480.90 },
    ...
    playoffs: [
      { round: 'Wildcard',      home: 'Grandes',     homeScore: 213.24, away: 'eldridsm',      awayScore: 126.78, winner: 'Grandes'     },
      { round: 'Wildcard',      home: 'rbr',         homeScore: 169.98, away: 'eldridm20',     awayScore: 157.10, winner: 'rbr'         },
      { round: 'Semifinal',     home: 'MLSchools12', homeScore: 138.12, away: 'Grandes',       awayScore: 140.92, winner: 'Grandes'     },
      { round: 'Semifinal',     home: 'JuicyBussy',  homeScore: 151.36, away: 'rbr',           awayScore: 166.04, winner: 'rbr'         },
      { round: 'Championship',  home: 'Grandes',     homeScore: 137.82, away: 'rbr',           awayScore: 115.08, winner: 'Grandes'     },
      { round: '3rd Place',     home: 'MLSchools12', homeScore: 178.80, away: 'JuicyBussy',    awayScore: 122.28, winner: 'MLSchools12' },
    ],
    narratives: [
      'Grandes wins the championship — the Commissioner claims the crown as the lowest-seeded team in the bracket.',
      'rbr reaches their only championship game — finishing runner-up after defeating JuicyBussy in the semis.',
      "Grandes knocked out the #1 seed MLSchools12 in the semis (140.92-138.12) before winning it all.",
    ],
  },
  ...
  '2023': {
    ...
    standings: [
      ...
      { rank: 2,  teamName: 'Grandes',         owner: 'Grandes',         wins: 9,  losses: 5,  pointsFor: 2134.06 },
      { rank: 3,  teamName: 'eldridsm',        owner: 'eldridsm',        wins: 9,  losses: 5,  pointsFor: 1995.28 },
      { rank: 4,  teamName: 'Cmaleski',        owner: 'Cmaleski',        wins: 9,  losses: 5,  pointsFor: 1958.66 },
      ...
      { rank: 9,  teamName: 'tdtd19844',       owner: 'tdtd19844',       wins: 5,  losses: 9,  pointsFor: 1639.20 },
      { rank: 10, teamName: 'SexMachineAndyD', owner: 'SexMachineAndyD', wins: 5,  losses: 9,  pointsFor: 1615.18 },
      { rank: 11, teamName: 'Cogdeill11',      owner: 'Cogdeill11',      wins: 3,  losses: 11, pointsFor: 1538.30 },
      { rank: 12, teamName: 'MCSchools',       owner: 'MCSchools',       wins: 2,  losses: 12, pointsFor: 1526.06 },
    ],
    playoffs: [
      { round: 'Wildcard',      home: 'Cmaleski',    homeScore: 94.64,  away: 'eldridm20',    awayScore: 141.60, winner: 'eldridm20'  },
      { round: 'Wildcard',      home: 'eldridsm',    homeScore: 115.14, away: 'JuicyBussy',   awayScore: 160.80, winner: 'JuicyBussy' },
      { round: 'Semifinal',     home: 'MLSchools12', homeScore: 145.48, away: 'eldridm20',    awayScore: 154.30, winner: 'eldridm20'  },
      { round: 'Semifinal',     home: 'Grandes',     homeScore: 143.04, away: 'JuicyBussy',   awayScore: 201.80, winner: 'JuicyBussy' },
      { round: 'Championship',  home: 'JuicyBussy',  homeScore: 179.40, away: 'eldridm20',    awayScore: 149.62, winner: 'JuicyBussy' },
      { round: '3rd Place',     home: 'MLSchools12', homeScore: 200.82, away: 'Grandes',      awayScore: 118.38, winner: 'MLSchools12' },
    ],
    narratives: [
      'JuicyBussy wins the championship as a 6-seed — the lowest-seeded champion in BMFFFL Sleeper history.',
      'eldridm20 upsets 13-1 MLSchools12 in the semis (154.30-145.48), then falls in the final.',
  ...
  '2024': {
    ...
    standings: [
      ...
      { rank: 4,  teamName: 'JuicyBussy',      owner: 'JuicyBussy',      wins: 8,  losses: 6,  pointsFor: 2036.54 },
      { rank: 5,  teamName: 'tdtd19844',       owner: 'tdtd19844',       wins: 8,  losses: 6,  pointsFor: 1915.58 },
      { rank: 6,  teamName: 'rbr',             owner: 'rbr',             wins: 8,  losses: 6,  pointsFor: 1891.12 },
      { rank: 7,  teamName: 'Grandes',         owner: 'Grandes',         wins: 7,  losses: 7,  pointsFor: 1941.48 },
      { rank: 8,  teamName: 'eldridm20',       owner: 'eldridm20',       wins: 6,  losses: 8,  pointsFor: 1917.28 },
      { rank: 9,  teamName: 'Cmaleski',        owner: 'Cmaleski',        wins: 4,  losses: 10, pointsFor: 1718.72 },
      { rank: 10, teamName: 'Cogdeill11',      owner: 'Cogdeill11',      wins: 4,  losses: 10, pointsFor: 1670.02 },
      { rank: 11, teamName: 'eldridsm',        owner: 'eldridsm',        wins: 4,  losses: 10, pointsFor: 1601.00 },
      { rank: 12, teamName: 'MCSchools',       owner: 'MCSchools',       wins: 3,  losses: 11, pointsFor: 1312.36 },
    ],
    playoffs: [
      { round: 'Wildcard',      home: 'JuicyBussy',      homeScore: 122.68, away: 'tdtd19844',      awayScore: 87.22,  winner: 'JuicyBussy'      },
      { round: 'Wildcard',      home: 'rbr',             homeScore: 136.64, away: 'MLSchools12',    awayScore: 183.16, winner: 'MLSchools12'     },
      { round: 'Semifinal',     home: 'SexMachineAndyD', homeScore: 215.38, away: 'JuicyBussy',     awayScore: 130.18, winner: 'SexMachineAndyD' },
      { round: 'Semifinal',     home: 'Tubes94',         homeScore: 138.28, away: 'MLSchools12',    awayScore: 158.66, winner: 'MLSchools12'     },
      { round: 'Championship',  home: 'MLSchools12',     homeScore: 168.40, away: 'SexMachineAndyD', awayScore: 146.86, winner: 'MLSchools12'     },
      { round: '3rd Place',     home: 'Tubes94',         homeScore: 163.46, away: 'JuicyBussy',     awayScore: 159.98, winner: 'Tubes94'         },
    ],
    narratives: [
      'MLSchools12 claims their second Sleeper-era ring from the #3 seed, defeating SexMachineAndyD in the final.',
      'SexMachineAndyD reaches the championship for the second time (2021 and 2024), falling short both times.',
      "Tubes94 edged JuicyBussy 163.46-159.98 in the 3rd place game — 3.48 points separated them.",
    ],
  },
  ...
  '2025': {
    ...
    standings: [
      ...
      { rank: 6,  teamName: 'Cmaleski',        owner: 'Cmaleski',        wins: 6,  losses: 8,  pointsFor: 1990.08 },
      { rank: 7,  teamName: 'eldridm20',       owner: 'eldridm20',       wins: 6,  losses: 8,  pointsFor: 1804.50 },
      { rank: 8,  teamName: 'MCSchools',       owner: 'MCSchools',       wins: 6,  losses: 8,  pointsFor: 1695.48 },
      { rank: 9,  teamName: 'eldridsm',        owner: 'eldridsm',        wins: 5,  losses: 9,  pointsFor: 1751.84 },
      { rank: 10, teamName: 'rbr',             owner: 'rbr',             wins: 5,  losses: 9,  pointsFor: 1698.16 },
      { rank: 11, teamName: 'Cogdeill11',      owner: 'Cogdeill11',      wins: 5,  losses: 9,  pointsFor: 1626.50 },
      { rank: 12, teamName: 'Grandes',         owner: 'Grandes',         wins: 4,  losses: 10, pointsFor: 1548.32 },
    ],
    playoffs: [
      { round: 'Wildcard',      home: 'JuicyBussy',  homeScore: 138.44, away: 'tdtd19844',     awayScore: 195.82, winner: 'tdtd19844'  },
      { round: 'Wildcard',      home: 'SexMachineAndyD', homeScore: 142.86, away: 'Cmaleski',  awayScore: 173.40, winner: 'Cmaleski'   },
      { round: 'Semifinal',     home: 'MLSchools12', homeScore: 120.16, away: 'tdtd19844',     awayScore: 137.70, winner: 'tdtd19844'  },
      { round: 'Semifinal',     home: 'Tubes94',     homeScore: 182.36, away: 'Cmaleski',      awayScore: 146.60, winner: 'Tubes94'    },
      { round: 'Championship',  home: 'tdtd19844',   homeScore: 152.92, away: 'Tubes94',       awayScore: 135.08, winner: 'tdtd19844'  },
      { round: '3rd Place',     home: 'MLSchools12', homeScore: 90.68,  away: 'Cmaleski',      awayScore: 89.74,  winner: 'MLSchools12' },
    ],
    narratives: [
      'tdtd19844 wins the championship as the #4 seed — 195.82-pt wildcard explosion, then upset of 13-1 MLSchools12 in the semis.',
      'Tubes94 reaches their first final, falling 152.92-135.08. Cmaleski ousts the #3 seed SexMachineAndyD as a #6.',
      "MLSchools12 edges Cmaleski 90.68-89.74 for 3rd — the narrowest margin (0.94 pts) in any BMFFFL playoff game.",
    ],
  },

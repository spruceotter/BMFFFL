...
const SEASONS_DATA: Record<string, SeasonPageData> = {
  ...
  '2019': {
    ...
    standings: [
      ...
      { rank: 9,  teamName: 'Juicy Bussy',              owner: 'Matt DeLaura',    wins: 6,  losses: 7,  pointsFor: 1611.86 },
      { rank: 10, teamName: 'No Name',                  owner: 'Dan Gaudy',       wins: 5,  losses: 8,  pointsFor: 1655.90 },
      { rank: 11, teamName: 'Trust the Process',        owner: 'Matt Moodie',     wins: 4,  losses: 9,  pointsFor: 1632.78 },
      { rank: 12, teamName: 'Lost hope',                owner: 'tyler drysdale',  wins: 3,  losses: 10, pointsFor: 1348.90 },
    ],
    playoffs: [
  ...
  '2017': {
    ...
    standings: [
      ...
      { rank: 8,  teamName: "Moodie's Team",            owner: 'Matt Moodie',     wins: 4,  losses: 9,  pointsFor: 1420.24 },
      { rank: 9,  teamName: "Gaudy's Team",             owner: 'Dan Gaudy',       wins: 4,  losses: 9,  pointsFor: 1459.46 },
      { rank: 10, teamName: "Drysdale's Team",          owner: 'tyler drysdale',  wins: 4,  losses: 9,  pointsFor: 1442.08 },
      { rank: 11, teamName: "DeLaura's Team",           owner: 'Matt DeLaura',    wins: 4,  losses: 9,  pointsFor: 1511.14 },

...
const AWARDS: Award[] = [
  {
    ...
    detail: 'Four championships across all eras (2016, 2019, 2021, 2024). 13-1 regular season record in 2025 (and again in 2023) — the only manager to ever achieve that mark, and did it twice. The standard everyone else is chasing.',
    icon: 'trophy',
    color: '#ffd700',
  ...
  },
  {
    ...
    winner: 'tdtd19844',
    acceptanceQuote: '"The arc never ends."',
    detail: 'The 2025 BMFFFL champion — won it the hard way as the 4-seed dark horse. Defeated Tubes94 152.92–135.08 in the title game. Built a durable, age-balanced roster over years of patient accumulation. The window wasn\'t opening — it was already open.',
    icon: 'crown',
    color: '#fb923c',

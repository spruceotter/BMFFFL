    ...
    awards: [
      {
        ...
        name: 'Champion',
        winner: 'MLSchools12',
        context: '11-3 regular season — league-best 2,327.10 points scored, first ring claimed',
        icon: 'trophy',
        accentColor: 'gold',
      },
      {
      ...
      },
      {
        ...
        name: 'Best Regular Season',
        winner: 'MLSchools12',
        context: '11-3, 2,327.10 points — best single-season scoring total in BMFFFL history',
        icon: 'trending-up',
        accentColor: 'blue',
      },
      {

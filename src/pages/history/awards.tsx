    ...
    awards: [
      {
        ...
        name: 'Champion',
        winner: 'MLSchools12',
        context: '13-1 regular season, #1 seed — back-to-back titles, cementing dynasty status',
        icon: 'trophy',
        accentColor: 'gold',
      },
      {
      ...
      },
      {
        ...
        winner: 'MLSchools12',
        context: '13-1 — the second 13-1 season in BMFFFL history, back-to-back by the same owner',
        icon: 'trending-up',
        accentColor: 'blue',
      },
      {
        ...
        winner: 'tdtd19844',
        context: '8-6 regular season, 4th seed — lost in the semis to the eventual champion',
        icon: 'heart-crack',
        accentColor: 'red',
      },
      {
      ...
      },
      {
        ...
        winner: 'MLSchools12',
        context: '"Two rings. Zero mercy. Back-to-back titles — the dynasty is no longer a theory."',
        icon: 'star',
        accentColor: 'purple',
      },
    ],
    ...
    awards: [
      {
        ...
        name: 'Champion',
        winner: 'MLSchools12',
        context: '10-4, 3rd seed — won their second ring by playing best when it matters most',
        icon: 'trophy',
        accentColor: 'gold',
      },
      {
  ...
  },
  {
    ...
    awards: [
      ...
      },
      {
        ...
        name: 'Runner-Up',
        winner: 'rbr',
        context: 'First of two runner-up finishes — lost the championship 150.90–103.38',
        icon: 'medal',
        accentColor: 'silver',
      },
      {
      ...
      },
      {
        ...
        name: 'Playoff Heartbreak',
        winner: 'SexMachineAndyD',
        context: '10-4 regular season — lost in the semis despite the second-best record in the league',
        icon: 'heart-crack',
        accentColor: 'red',
      },
      {

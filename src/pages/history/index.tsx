...
// Runner-up mappings: chrisrioux=Grandes, mrio19=rbr, drc1183=Cogdeill11, vieyramf@sbu.edu=SexMachineAndyD (changed username when migrating to Sleeper).
const CHAMPIONS: ChampionEntry[] = [
  ...
  },
  {
    ...
    tagline: 'Stand Against Trade Rape — SexMachineAndyD claims his ring on ESPN',
...
const ALL_TIME_RECORDS: OwnerRecord[] = [
  ...
  { owner: 'eldridm20',       rings: 0, playoffApps: 4,  wins: 57,  losses: 78  },

...
const BRACKETS: SeasonBracket[] = [
  {
    ...
    champion: 'tdtd19844',
    championSeed: 4,
    summary: 'The ultimate dark horse. tdtd19844 went 8-6, entered as the 4th seed, and took down the 13-1 MLSchools12 in the semis — the biggest upset in BMFFFL playoff history. Then defeated Tubes94 in the championship 152.92–135.08. Cmaleski also shocked SexMachineAndyD as the #6 seed in wildcards.',
    quarterFinals: [
      {
        round: 'QF',
        top: { seed: 4, name: 'tdtd19844', record: '8-6', score: 195.82, winner: true },
        bottom: { seed: 5, name: 'JuicyBussy', record: '7-7', score: 138.44, winner: false },
        upset: false,
      },
      {
        round: 'QF',
        top: { seed: 3, name: 'SexMachineAndyD', record: '9-5', score: 142.86, winner: false },
        bottom: { seed: 6, name: 'Cmaleski', record: '6-8', score: 173.40, winner: true },
        upset: true,
        note: '#6 over #3',
      },
    ],
    semiFinals: [
      {
        round: 'SF',
        top: { seed: 1, name: 'MLSchools12', record: '13-1', score: 120.16, winner: false, bye: true },
        bottom: { seed: 4, name: 'tdtd19844', record: '8-6', score: 137.70, winner: true },
        upset: true,
        note: '#4 upsets #1 — 13-1 season ends in heartbreak',
      },
      {
        round: 'SF',
        top: { seed: 2, name: 'Tubes94', record: '10-4', score: 182.36, winner: true, bye: true },
        bottom: { seed: 6, name: 'Cmaleski', record: '6-8', score: 146.60, winner: false },
        upset: false,
      },
    ],
    championship: {
  ...
  },
  {
    ...
    championSeed: 3,
    summary: 'MLSchools12 claims their fourth all-time championship from the #3 seed. SexMachineAndyD earned the #1 seed (11-3) and reached the final, but fell to MLSchools12 for the second time — their second runner-up finish.',
    quarterFinals: [
      {
        round: 'QF',
        top: { seed: 4, name: 'JuicyBussy', record: '8-6', score: 122.68, winner: true },
        bottom: { seed: 5, name: 'tdtd19844', record: '8-6', score: 87.22, winner: false },
        upset: false,
      },
      {
        round: 'QF',
        top: { seed: 6, name: 'rbr', record: '8-6', score: 136.64, winner: false },
        bottom: { seed: 3, name: 'MLSchools12', record: '10-4', score: 183.16, winner: true },
        upset: true,
        note: '#3 dispatches #6',
      },
    ],
    semiFinals: [
      {
        round: 'SF',
        top: { seed: 1, name: 'SexMachineAndyD', record: '11-3', score: 215.38, winner: true, bye: true },
        bottom: { seed: 4, name: 'JuicyBussy', record: '8-6', score: 130.18, winner: false },
        upset: false,
      },
      {
        round: 'SF',
        top: { seed: 2, name: 'Tubes94', record: '11-3', score: 138.28, winner: false, bye: true },
        bottom: { seed: 3, name: 'MLSchools12', record: '10-4', score: 158.66, winner: true },
        upset: true,
        note: '#3 over #2 bye',
      },
    ],
    championship: {
      round: 'Championship',
      top: { seed: 3, name: 'MLSchools12', record: '10-4', score: 168.40, winner: true },
      bottom: { seed: 1, name: 'SexMachineAndyD', record: '11-3', score: 146.86, winner: false },
      upset: false,
    },
  },
  {
    ...
    championSeed: 6,
    cinderella: true,
    cinderellaNote: 'The lowest seed (6th) ever to win the BMFFFL — 3 consecutive upsets',
    summary: 'The greatest Cinderella run in BMFFFL history. JuicyBussy entered as the 6th seed and won three straight games to claim the title. eldridm20 slayed the 13-1 #1 seed MLSchools12 in the semis.',
    quarterFinals: [
      {
        round: 'QF',
        top: { seed: 4, name: 'Cmaleski', record: '9-5', score: 94.64, winner: false },
        bottom: { seed: 5, name: 'eldridm20', record: '8-6', score: 141.60, winner: true },
        upset: true,
        note: '#5 over #4',
      },
      {
        round: 'QF',
        top: { seed: 3, name: 'eldridsm', record: '9-5', score: 115.14, winner: false },
        bottom: { seed: 6, name: 'JuicyBussy', record: '8-6', score: 160.80, winner: true },
        upset: true,
        note: '#6 over #3',
      },
    ],
    semiFinals: [
      {
        round: 'SF',
        top: { seed: 1, name: 'MLSchools12', record: '13-1', score: 145.48, winner: false, bye: true },
        bottom: { seed: 5, name: 'eldridm20', record: '8-6', score: 154.30, winner: true },
        upset: true,
        note: 'Giant kill — 13-1 #1 seed falls',
      },
      {
        round: 'SF',
        top: { seed: 2, name: 'Grandes', record: '9-5', score: 143.04, winner: false, bye: true },
        bottom: { seed: 6, name: 'JuicyBussy', record: '8-6', score: 201.80, winner: true },
        upset: true,
        note: '#6 over #2 — 201.80 pts',
      },
    ],
    championship: {
      round: 'Championship',
      top: { seed: 6, name: 'JuicyBussy', score: 179.40, winner: true },
      bottom: { seed: 5, name: 'eldridm20', score: 149.62, winner: false },
      upset: false,
  ...
  },
  {
    ...
    champion: 'Grandes',
    championSeed: 4,
    summary: 'Grandes upset #1 MLSchools12 in the semis by 2.80 points, then claimed the title over rbr. Grandes entered as the 4th seed — the first non-top-3 champion in BMFFFL history. rbr\'s only championship appearance.',
    quarterFinals: [
      {
        round: 'QF',
        top: { seed: 4, name: 'Grandes', record: '8-6', score: 213.24, winner: true },
        bottom: { seed: 5, name: 'eldridsm', record: '8-6', score: 126.78, winner: false },
        upset: false,
      },
      {
        round: 'QF',
        top: { seed: 3, name: 'rbr', record: '10-4', score: 169.98, winner: true },
        bottom: { seed: 6, name: 'eldridm20', record: '7-7', score: 157.10, winner: false },
        upset: false,
      },
    ],
    semiFinals: [
      {
        round: 'SF',
        top: { seed: 1, name: 'MLSchools12', record: '10-4', score: 138.12, winner: false, bye: true },
        bottom: { seed: 4, name: 'Grandes', record: '8-6', score: 140.92, winner: true },
        upset: true,
        note: '#4 over #1 — by 2.80 pts',
      },
      {
        round: 'SF',
        top: { seed: 2, name: 'JuicyBussy', record: '10-4', score: 151.36, winner: false, bye: true },
        bottom: { seed: 3, name: 'rbr', record: '10-4', score: 166.04, winner: true },
        upset: true,
        note: '#3 over #2 bye',
      },
    ],
    championship: {
      round: 'Championship',
      top: { seed: 4, name: 'Grandes', record: '8-6', score: 137.82, winner: true },
      bottom: { seed: 3, name: 'rbr', record: '10-4', score: 115.08, winner: false },
      upset: false,
      note: 'rbr\'s only championship appearance',
    },
  },
  {
    year: 2021,
    champion: 'MLSchools12',
    championSeed: 1,
    summary: 'MLSchools12 went 11-3 in the regular season and backed it up in the playoffs. SexMachineAndyD reached the final for the first of two times, falling 193.10-111.34. rbr and Grandes fell in the semis.',
    quarterFinals: [
      {
        round: 'QF',
        top: { seed: 5, name: 'rbr', record: '9-5', score: 132.90, winner: true },
        bottom: { seed: 4, name: 'Cogdeill11', record: '9-5', score: 129.28, winner: false },
        upset: false,
      },
      {
        round: 'QF',
        top: { seed: 3, name: 'Grandes', record: '10-4', score: 145.08, winner: true },
        bottom: { seed: 6, name: 'JuicyBussy', record: '8-6', score: 65.78, winner: false },
        upset: false,
      },
    ],
    semiFinals: [
      {
        round: 'SF',
        top: { seed: 1, name: 'MLSchools12', record: '11-3', score: 150.90, winner: true, bye: true },
        bottom: { seed: 5, name: 'rbr', record: '9-5', score: 103.38, winner: false },
        upset: false,
      },
      {
        round: 'SF',
        top: { seed: 2, name: 'SexMachineAndyD', record: '10-4', score: 127.92, winner: true, bye: true },
        bottom: { seed: 3, name: 'Grandes', record: '10-4', score: 115.72, winner: false },
        upset: false,
      },
    ],
    championship: {
      round: 'Championship',
      top: { seed: 1, name: 'MLSchools12', record: '11-3', score: 193.10, winner: true },
      bottom: { seed: 2, name: 'SexMachineAndyD', record: '10-4', score: 111.34, winner: false },
      upset: false,
      note: 'SexMachineAndyD\'s first of two runner-up finishes',
    },
  },
  {
    year: 2020,
    champion: 'Cogdeill11',
    championSeed: 2,
    summary: 'The inaugural BMFFFL championship, decided by just 4.76 points — the closest title game in league history. eldridsm stunned 11-2 #1 seed MLSchools12 in the semis. tdtd19844 upset the #3 seed SexMachineAndyD in wildcards.',
    quarterFinals: [
      {
        round: 'QF',
        top: { seed: 3, name: 'SexMachineAndyD', record: '9-4', score: 98.50, winner: false },
        bottom: { seed: 6, name: 'tdtd19844', record: '6-7', score: 127.86, winner: true },
        upset: true,
        note: '#6 over #3',
      },
      {
        round: 'QF',
        top: { seed: 5, name: 'rbr', record: '6-7', score: 117.12, winner: false },
        bottom: { seed: 4, name: 'eldridsm', record: '8-5', score: 138.10, winner: true },
        upset: false,
      },
    ],
    semiFinals: [
      {
        round: 'SF',
        top: { seed: 1, name: 'MLSchools12', record: '11-2', score: 156.86, winner: false, bye: true },
        bottom: { seed: 4, name: 'eldridsm', record: '8-5', score: 181.06, winner: true },
        upset: true,
        note: '181 pts — giant killer',
      },
      {
        round: 'SF',
        top: { seed: 2, name: 'Cogdeill11', record: '10-3', score: 160.54, winner: true, bye: true },
        bottom: { seed: 6, name: 'tdtd19844', record: '6-7', score: 155.82, winner: false },
        upset: false,
      },
    ],
    championship: {
      ...
      bottom: { seed: 4, name: 'eldridsm', record: '8-5', score: 198.34, winner: false },
      upset: false,

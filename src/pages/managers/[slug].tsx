...
const MANAGERS: ManagerProfile[] = [
  {
    ...
    bio: "The undisputed dynasty of the BMFFFL era. Three championships in five years — 2021, 2024, and a commanding 2025 title over Tubes94 (221.4–198.7). Holds the all-time wins record with a .822 win percentage. Six consecutive playoff appearances and counting. Every season is a championship run.",
    seasons: [
      ...
      { year: 2025, wins: 13, losses: 1, pointsFor: 2120, pointsAgainst: 1590, finish: 1, result: 'champion' },
    ],
    roster: [
      'CeeDee Lamb (WR)',
      'Tyreek Hill (WR)',
    ...
    rivalries: [
      { opponent: 'Tubes94', record: '8-2', description: 'The 2025 championship clash — MLSchools12 triumphed 221.4–198.7 to claim the 3-peat.' },
  ...
  },
  {
    ...
    bio: "The greatest rebuild story in the league. Went 3-11 in 2022 and finished dead last. Quietly accumulated assets through losing seasons, then exploded as a contender in 2024-25. Three straight playoff appearances. The league's dark horse entering every season.",
    seasons: [
      ...
      { year: 2025, wins: 8, losses: 6, pointsFor: 1710, pointsAgainst: 1630, finish: 4, result: 'playoff' },
    ],
    roster: [
      'Jayden Daniels (QB)',
      'Kyren Williams (RB)',

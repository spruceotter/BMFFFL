...
const MANAGERS: ManagerProfile[] = [
  ...
  },
  {
    ...
    bio: "The quintessential veteran manager. 2019 and 2022 runner-up. Eight playoff appearances — 4 ESPN (2016–2019) + 4 Sleeper — the most of any manager without a title. Best lineup IQ in the league (89.78%). Never the flashiest — always dangerous.",
    seasons: [

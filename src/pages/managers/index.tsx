...
const MANAGERS: Manager[] = [
  {
    ...
    playoffApps: 6,
    dynastyRank: 1,
    tagline: "Dynasty's undisputed king — 3x champion",
  },
  {
    slug: 'tubes94',
    displayName: 'Tubes94',
  ...
  },
  {
    ...
    playoffApps: 4,
    dynastyRank: 3,
    tagline: '2024 runner-up — 4x playoffs, elite consistency',
  },
  {
    slug: 'cogdeill11',
    ...
    playoffApps: 2,
    dynastyRank: 4,
    tagline: '2020 founding champion',
  },
  {
    slug: 'grandes',
    displayName: 'Grandes',
  ...
  },
  {
    ...
    playoffApps: 5,
    dynastyRank: 6,
    tagline: '2023 champion — most explosive offense ever',
  },
  {
    slug: 'tdtd19844',
    ...
    playoffApps: 3,
    dynastyRank: 7,
    tagline: 'Went 3-11, now a legit contender',
  },
  {
    slug: 'eldridm20',
    ...
    playoffApps: 3,
    dynastyRank: 8,
    tagline: '2023 runner-up — consistent finisher',
  },
  {
    slug: 'rbr',
    displayName: 'RBR',
    ...
    playoffApps: 5,
    dynastyRank: 9,
    tagline: 'Veteran manager — 5x playoffs',
  },
  {
    slug: 'bro_set',
    displayName: 'Bro_Set',
    ...
    playoffApps: 1,
    dynastyRank: 10,
    tagline: 'Expansion manager — steady improvement',
  },
  {
    ...
    playoffApps: 4,
    dynastyRank: 11,
    tagline: '2022 runner-up — playoff regular',
  },
  {
    slug: 'jimmyeatwurld',
    ...
    playoffApps: 1,
    dynastyRank: 12,
    tagline: 'Expansion manager — chaotic good',
  },
];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-8 p-4 rounded-xl bg-[#16213e] border border-[#2d4a66] flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-slate-300">
                ...
                championships awarded (2020–2025)
              </span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="mb-8 rounded-xl bg-[#16213e] border border-[#ffd700]/20 p-5">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                { year: 2020, winner: 'Cogdeill11' },
                { year: 2021, winner: 'MLSchools12' },
                { year: 2022, winner: 'Grandes' },
                { year: 2023, winner: 'JuicyBussy', note: 'def. Eldridm20' },
                { year: 2024, winner: 'MLSchools12' },
                { year: 2025, winner: 'MLSchools12', note: 'def. Tubes94, 221.4–198.7' },

...
// Champion history validated 2026-04-14. ESPN era (2016-2019) confirmed by Commissioner.
// Sleeper era (2020-2025) verified from SQLite DB. Win/loss records are Sleeper era only.
const MANAGERS: Manager[] = [
  {
    ...
    runnerUps: [],
    overallRecord: { wins: 68, losses: 15 },
    playoffApps: 6,
    dynastyRank: 1,
  ...
  },
  {
    ...
    championships: [2018],
    runnerUps: [2021, 2024],
    overallRecord: { wins: 50, losses: 33 },
    playoffApps: 5,
    dynastyRank: 3,
  ...
  },
  {
    ...
    playoffApps: 5,
    dynastyRank: 9,
    tagline: '2022 runner-up — 5x playoffs, franchise veteran',
  },
  {
    slug: 'eldridsm',

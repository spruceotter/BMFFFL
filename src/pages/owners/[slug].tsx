...
const OWNERS = [
  ...
  },
  {
    ...
    seasons: [
      ...
      { year: 2017, rank: 3, wins: 9, losses: 4, champion: false },
      { year: 2018, rank: 1, wins: 9, losses: 4, champion: true },
      { year: 2019, rank: 8, wins: 7, losses: 6, champion: false },
  ...
  },
  {
    ...
    seasons: [
      { year: 2016, rank: 6, wins: 9, losses: 4, champion: false },
      { year: 2017, rank: 11, wins: 4, losses: 9, champion: false },
      { year: 2018, rank: 11, wins: 2, losses: 11, champion: false },
      { year: 2019, rank: 9, wins: 6, losses: 7, champion: false },
  ...
  },
  {
    ...
    seasons: [
      ...
      { year: 2017, rank: 6, wins: 8, losses: 5, champion: false },
      { year: 2018, rank: 5, wins: 8, losses: 5, champion: false },
      { year: 2019, rank: 2, wins: 6, losses: 7, champion: false },
  ...
  },
  {
    ...
    seasons: [
      { year: 2016, rank: 2, wins: 8, losses: 5, champion: false },
      { year: 2017, rank: 7, wins: 6, losses: 7, champion: false },
      { year: 2018, rank: 8, wins: 7, losses: 6, champion: false },
      { year: 2019, rank: 4, wins: 8, losses: 5, champion: false },
  ...
  },
  {
    ...
    wins: 55, losses: 80,
    dynastyRank: 8,
    status: '2025 champion. A founding ESPN-era member (2016) who went 19-33 in the ESPN era, struggled through early Sleeper seasons (3-11 in 2022), then won the 2025 title as 4th seed — a decade-long arc from founding member to champion.',
    currentRoster: ['Jayden Daniels (QB)', 'Kyren Williams (RB)', 'Tee Higgins (WR)', 'Sam LaPorta (TE)', 'Jalen McMillan (WR)'],
    seasons: [
      { year: 2016, rank: 5,  wins: 7,  losses: 6,  champion: false },
      { year: 2017, rank: 10, wins: 4,  losses: 9,  champion: false },
      { year: 2018, rank: 9,  wins: 5,  losses: 8,  champion: false },
      { year: 2019, rank: 11, wins: 3,  losses: 10, champion: false },
  ...
  },
  {
    ...
    wins: 75, losses: 60,
    dynastyRank: 9,
    status: '2017 ESPN runner-up, 2020 runner-up. Eliminated the #1 seed MLSchools12 in the 2020 semis with 181 points. Three playoff appearances (2020, 2022, 2023).',
    currentRoster: ['Dak Prescott (QB)', 'Isiah Pacheco (RB)', 'Courtland Sutton (WR)', 'Cole Kmet (TE)', 'Demario Douglas (WR)'],
    seasons: [
      { year: 2016, rank: 9, wins: 6, losses: 7, champion: false },
      { year: 2017, rank: 2, wins: 11, losses: 2, champion: false },
      { year: 2018, rank: 6, wins: 7, losses: 6, champion: false },
      { year: 2019, rank: 3, wins: 10, losses: 3, champion: false },
  ...
  },
  {
    ...
    seasons: [
      { year: 2016, rank: 8, wins: 3, losses: 10, champion: false },
      { year: 2017, rank: 12, wins: 2, losses: 11, champion: false },
      { year: 2018, rank: 7, wins: 6, losses: 7, champion: false },
      { year: 2019, rank: 6, wins: 7, losses: 6, champion: false },
  ...
  },
  {
    ...
    seasons: [
      { year: 2016, rank: 4, wins: 8, losses: 5, champion: false },
      { year: 2017, rank: 5, wins: 7, losses: 6, champion: false },
      { year: 2018, rank: 9, wins: 2, losses: 11, champion: false },
      { year: 2019, rank: 7, wins: 2, losses: 11, champion: false },
      { year: 2020, rank: 6, wins: 6, losses: 7, champion: false },

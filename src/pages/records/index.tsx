...
const ALL_TIME_RECORDS: RecordEntry[] = [
  ...
  },
  {
    ...
    holder: 'MLSchools12',
    value: '114 Wins',
    context: '114–21 · .844 win% · 2016–Present (ESPN + Sleeper)',
    icon: 'star',
    highlight: true,
    note: 'The highest win percentage (.844) in BMFFFL history across all 10 seasons (ESPN + Sleeper).',
  },
  {
    id: 'most-playoff-appearances',
    title: 'Most Playoff Appearances',
    holder: 'MLSchools12',
    value: '10 Appearances',
    context: '2016 – 2025 (every season)',
    icon: 'award',
    note: 'The only team to make the playoffs in every single season across all 10 years of BMFFFL history (ESPN + Sleeper).',
  },
  {
